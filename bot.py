...
TIMEZONE = pytz.timezone("Asia/Novosibirsk")  # Новосибирск

MEAL_TIMES = [time(8, 0, 0), time(13, 0, 0), time(19, 0, 0)]
...
async def stats_command(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    if last_confirmation:
        ...
        message = "📊 Я ещё не получал подтверждений. Надеюсь, ты кушает регулярно!"
